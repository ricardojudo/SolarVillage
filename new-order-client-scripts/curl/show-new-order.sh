...
echo "Variables"
URL=http://localhost:8080/kie-server/services/rest/server/queries/processes/instances/$1/variables/instances
#URL=http://localhost:8080/kie-server/services/rest/server/containers/${CONTAINER_ID}/processes/instances/$1/variables
CURL="curl -X GET -H \"Accept: application/json\" --user jboss:bpms ${URL}"
echo ${CURL}
echo ${CURL} | bash